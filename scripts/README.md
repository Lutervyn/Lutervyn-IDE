...
Various scripts and configurations used to configure, build, and package Lutervyn IDE.
...
- **install-dependencies.sh**:   Installs required applications to build, package
                                 and run Lutervyn IDE, mainly useful for CI and documentation purpose.
...
- **generate-release-notes.sh**: Generates a release note for Lutervyn IDE releases.
