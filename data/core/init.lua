print("DEBUG: LOADED FROM SOURCE DATA DIRECTORY")
require "core.strict"
require "core.regex"
...
-- Load Lutervyn Dark theme
-- Load Lutervyn Dark theme (moved to end of file)
-- core.reload_module("colors.lutervyn_dark")
...
function core.init()
  ...
  -- Disable plugins (menubar is integrated into titleview)
  config.plugins.toolbarview = false
  config.plugins.menubar = false
  ...
  core.configure_borderless_window()
  core.reload_module("colors.lutervyn_dark") -- Force load our theme at the end
...
function core.compose_window_title(title)
  return (title == "" or title == nil) and "Lutervyn IDE" or title .. " - Lutervyn IDE"
end
