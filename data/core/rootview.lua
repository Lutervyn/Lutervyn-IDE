...
function RootView:on_mouse_pressed(button, x, y, clicks)
  -- Patch: prioritize TitleView menu context interaction
  if core.title_view and core.title_view.menu_context.show_context_menu then
     if core.title_view:on_mouse_pressed(button, x, y, clicks) then return true end
  end
