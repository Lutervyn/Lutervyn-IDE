...
is hidden in the C source files of Lutervyn IDE. The idea of these files
...
of Lutervyn IDE core libraries and symbols when developing plugins or adding
any options to your **User Module File** (init.lua).

## The Base Core

Most of the code that is written in Lua for Lutervyn IDE is powered by the exposed
